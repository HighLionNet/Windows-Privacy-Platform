...
internal static class CatalogV22Expansion
{
    internal static IReadOnlyList<ManagedObject> CreateCoverageBatch()
    {
        var list = new List<ManagedObject>
        {
            ...
            Reg("policy.copilot.turnoff", "Turn Off Windows Copilot", "Controls whether Windows Copilot is available to users.", "Copilot can send prompts and selected context to cloud services.", ProductDomain.Copilot, "Windows Copilot", @"HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsCopilot\TurnOffWindowsCopilot", RiskLevel.Medium, FeatureCategory.AIComponent, 22621),
