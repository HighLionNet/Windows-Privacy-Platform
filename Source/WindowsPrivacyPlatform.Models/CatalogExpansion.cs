...
internal static class CatalogExpansion
{
    internal static IReadOnlyList<ManagedObject> CreateCoverageBatch()
    {
        ...
        list.Add(Pol("policy.bitlocker.requiredeviceencryption", "Require Device Encryption", "Device encryption requirement policy.", "Forces encryption posture where supported.", RiskLevel.High, FeatureCategory.RegistryPolicy, ComponentOwner.Other, ControlLevel.AdministratorControlled, ProductDomain.Device, "BitLocker", @"HKLM\SYSTEM\CurrentControlSet\Control\BitLocker\PreventDeviceEncryption"));
